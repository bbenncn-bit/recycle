...
"[project]/.next-internal/server/app/api/energy/efficiency-benchmark/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/lib/prismadb.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const prisma = global.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]({
    log: [
        "query",
        "error",
        "warn"
...
"[project]/src/lib/services/energy-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "CarbonAccountingService": (()=>CarbonAccountingService),
    ...
    "EnergyEfficiencyService": (()=>EnergyEfficiencyService),
    "EnergyFlowService": (()=>EnergyFlowService),
    "RealTimeEnergyService": (()=>RealTimeEnergyService),
    "SupplyChainService": (()=>SupplyChainService)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prismadb.ts [app-route] (ecmascript)");
;
class EnergyConsumptionService {
    // 获取能耗趋势数据
    static async getConsumptionTrend() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eAConsumptionTrend.findMany({
                orderBy: {
                    date: 'asc'
                }
            });
    ...
    static async getMonthSummary() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eAMonthSummary.findMany({
                orderBy: {
                    month: 'asc'
                }
            });
    ...
    static async getTypeComparison() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eATypeComparison.findMany({
                orderBy: {
                    month: 'asc'
                }
            });
...
class EnergyCalculationService {
    ...
    static async getBudgetComparison() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cBComparisonChart.findMany({
                orderBy: {
                    month: 'asc'
                }
            });
    ...
    static async getMonthlyDetails() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cBMonthlyDetails.findMany({
                orderBy: {
                    month: 'asc'
                }
            });
    ...
    static async getSummaryCards() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cBSummaryCards.findMany();
            return data;
        } catch (error) {
...
class EnergyAnalysisService {
    ...
    static async getStrategies() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eAStrategy.findMany();
            return data;
        } catch (error) {
...
class EnergyEfficiencyService {
    ...
    static async getBenchmarkRankCards() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eEBenchmarkRankCards.findMany({
                orderBy: {
                    rank: 'asc'
                }
            });
    ...
    static async getGaugeMetrics() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eEGaugeMetrics.findMany();
            return data;
        } catch (error) {
    ...
    static async getRankingList() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eERankingList.findMany({
                orderBy: {
                    rank: 'asc'
                }
            });
    ...
    static async getTrendChartData() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eETrendChartData.findMany({
                orderBy: {
                    month: 'asc'
                }
            });
...
class EnergyFlowService {
    ...
    static async getSankeyNodes() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eFSankeyNodes.findMany({
                orderBy: {
                    node: 'asc'
                }
            });
    ...
    static async getSankeyLinks() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eFSankeyLinks.findMany();
            return data;
        } catch (error) {
    ...
    static async getSummaryTable() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eFSummaryTable.findMany();
            return data;
        } catch (error) {
...
class EnergyBalanceService {
    ...
    static async getParamCards() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eBParamCards.findMany();
            return data;
        } catch (error) {
    ...
    static async getPieChart() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eBPieChart.findMany();
            return data;
        } catch (error) {
    ...
    static async getResults() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eBResults.findMany();
            return data;
        } catch (error) {
    ...
    static async getTrendChart() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eBTrendChart.findMany({
                orderBy: {
                    time: 'asc'
                }
            });
...
class CarbonAccountingService {
    ...
    static async getCarbonDetails() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cFDetails.findMany();
            return data;
        } catch (error) {
    ...
    static async getCarbonPieChart() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cFPieChart.findMany();
            return data;
        } catch (error) {
    ...
    static async getCarbonTrendChart() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cFTrendChart.findMany({
                orderBy: {
                    month: 'asc'
                }
            });
...
class CarbonAssetService {
    // 获取碳资产持仓数据
    static async getHoldings() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cAHoldings.findMany();
            return data;
        } catch (error) {
    ...
    static async getMarketCards() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cAMarketCards.findMany();
            return data;
        } catch (error) {
    ...
    static async getPriceChart() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cAPriceChart.findMany({
                orderBy: {
                    date: 'asc'
                }
            });
...
class SupplyChainService {
    ...
    static async getSupplierRanking() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sCRanking.findMany({
                orderBy: {
                    rank: 'asc'
                }
            });
    ...
    static async getSupplyChainSankey() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sCSankeyData.findMany();
            return data;
        } catch (error) {
...
class RealTimeEnergyService {
    ...
    static async getEnergyTypes() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eCenergyTypes.findMany();
            return data;
        } catch (error) {
    ...
    static async getRealTimeData() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eCrealTime.findMany({
                orderBy: {
                    timestamp: 'desc'
                }
            });
    ...
    static async getHistoryData() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eChistory.findMany({
                orderBy: {
                    date_time: 'desc'
                }
            });
    ...
    static async getEnergyFlowRealTime() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].eCenergyFlowRealTime.findMany({
                orderBy: {
                    timestamp: 'desc'
                }
            });
...
"[project]/src/app/api/energy/efficiency-benchmark/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$energy$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/energy-service.ts [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        const [benchmarkCards, gaugeMetrics, rankingList, trendData] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$energy$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EnergyEfficiencyService"].getBenchmarkRankCards(),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$energy$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EnergyEfficiencyService"].getGaugeMetrics(),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$energy$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EnergyEfficiencyService"].getRankingList(),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$energy$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EnergyEfficiencyService"].getTrendChartData()
        ]);
        // 模拟能效对标数据（基于图示样式）
        const benchmarkData = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adac3028._.js.map