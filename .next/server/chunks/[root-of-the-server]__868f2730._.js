...
"[project]/.next-internal/server/app/api/receiptfg/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/lib/services/receipt-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "ReceiptfcService": (()=>ReceiptfcService),
    "ReceiptfgService": (()=>ReceiptfgService)
});
...
class ReceiptfcService {
   ...
   */ static async getLatestData() {
        try {
            ...
            // 获取该日期的所有数据
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfc.findMany({
                where: {
                    orderTime: {
                        gte: dateStart,
                        lt: dateEnd
    ...
    /**
   * 分页获取报废车数据
   */ static async getBatchData(params = {}) {
        try {
            ...
            const [data, total] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfc.findMany({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfc.count({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
    ...
    /**
   * 获取最新订单日期
   */ static async getLatestOrderDate() {
        const latestRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfc.findFirst({
            where: {
                orderTime: {
                    not: null
                }
    ...
    /**
   * 处理收据数据，添加图片处理逻辑
   */ static processReceiptData(data) {
   ...
   */ static parseImageUrls(imgUrls) {
    ...
    /**
   * 生成CDN压缩URL
   */ static generateProgressiveUrls(originalUrl) {
        if (!originalUrl) {
            return {
                tiny: '',
                small: '',
...
class ReceiptfgService {
   ...
   */ static async getLatestData() {
        try {
            ...
            // 获取该日期的所有数据
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfg.findMany({
                where: {
                    orderTime: {
                        gte: dateStart,
                        lt: dateEnd
   ...
   */ static async getBatchData(params = {}) {
        try {
            ...
            // 获取分页数据
            const [data, total] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfg.findMany({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfg.count({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
   ...
   * 获取最新订单日期
   */ static async getLatestOrderDate() {
        const latestRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].receiptfg.findFirst({
            where: {
                orderTime: {
                    not: null
                }
...
"[project]/src/app/api/receiptfg/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$receipt$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/receipt-service.ts [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$receipt$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ReceiptfgService"].getLatestData();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__868f2730._.js.map