...
"[project]/src/lib/prismadb.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const prisma = global.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PrismaClient"]({
    log: [
        "query",
        "error",
        "warn"
...
"[project]/src/lib/services/receipt-service.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prismadb.ts [app-rsc] (ecmascript)");
;
class ReceiptfcService {
   ...
   */ static async getLatestData() {
        try {
            ...
            // 获取该日期的所有数据
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfc.findMany({
                where: {
                    orderTime: {
                        gte: dateStart,
                        lt: dateEnd
   ...
   */ static async getBatchData(params = {}) {
        try {
            ...
            const [data, total] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfc.findMany({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfc.count({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
   ...
   */ static async getLatestOrderDate() {
        const latestRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfc.findFirst({
            where: {
                orderTime: {
                    not: null
                }
...
class ReceiptfgService {
   ...
   */ static async getLatestData() {
        try {
            ...
            // 获取该日期的所有数据
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfg.findMany({
                where: {
                    orderTime: {
                        gte: dateStart,
                        lt: dateEnd
   ...
   */ static async getBatchData(params = {}) {
        try {
            ...
            // 获取分页数据
            const [data, total] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfg.findMany({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfg.count({
                    where: {
                        orderTime: {
                            gte: dateStart,
                            lt: dateEnd
   ...
   * 获取最新订单日期
   */ static async getLatestOrderDate() {
        const latestRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prismadb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].receiptfg.findFirst({
            where: {
                orderTime: {
                    not: null
                }
...
"[project]/src/app/api/receiptfg/fetch-batch.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$receipt$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/receipt-service.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
;
async function getReceiptfgDataBatch(params = {}) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$receipt$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ReceiptfgService"].getBatchData(params);
}
;
...
;
;
async function getReceiptfcDataBatch(params = {}) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$receipt$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ReceiptfcService"].getBatchData(params);
}
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureServerEntryExports"])([
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/api/receiptfg/fetch-batch.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/api/receiptfc/fetch-batch.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$receiptfg$2f$fetch$2d$batch$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/receiptfg/fetch-batch.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$receiptfc$2f$fetch$2d$batch$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/receiptfc/fetch-batch.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$api$2f$receiptfg$2f$fetch$2d$batch$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$app$2f$api$2f$receiptfc$2f$fetch$2d$batch$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/api/receiptfg/fetch-batch.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/app/api/receiptfc/fetch-batch.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/api/receiptfg/fetch-batch.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/api/receiptfc/fetch-batch.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/api/receiptfg/fetch-batch.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/api/receiptfc/fetch-batch.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ea379a0._.js.map